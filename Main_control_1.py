...
# while True:
#     i = int(input("Enter the rotation angel of joint 1: "))
#     j = int(input("Enter the rotation angel of joint 2: "))
#     k = int(input("Enter the rotation angel of joint 3: "))
#     joint_rotation(1,i)
#     time.sleep(1)
#     joint_rotation(2,j)
#     time.sleep(1)
...
# while True:
#     i = float(input("Enter the duty cycle"))
#     j=end_effector(i)
#     print(str(j))

# while True:
#     i = int(input("Enter the No of pulses: "))
#     j = int(input("Enter the No Direction: "))
#     k = int(input("Enter the Speed: "))
#     rotation(i,j,k)
#     print(str(k))
